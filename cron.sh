...
# For executing update_db.py every two hours every day.
echo "0 */2 * * * source /home/irahorecka/pweb2/webenv/bin/activate && python /home/irahorecka/pweb2/update_db.py" >> mycron
