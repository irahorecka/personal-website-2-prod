...
# For executing update_db.py every two hours from 06:00 - 22:00 every day.
echo "0 6-22/2 * * * source /home/irahorecka/pweb2/webenv/bin/activate && python /home/irahorecka/pweb2/update_db.py" >> mycron
